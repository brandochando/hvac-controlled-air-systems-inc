...
// ─── Brand Identity ───────────────────────────────────────────────────────────
export const BRAND_NAME       = "Controlled Air";          // e.g. "AirPro"
export const BRAND_FULL_NAME  = "Controlled Air Systems Inc.";           // e.g. "AirPro Heating & Air Conditioning"
export const BRAND_LEGAL_NAME = "Controlled Air Systems Inc.";          // e.g. "AirPro Heating & Air Conditioning, Inc."
...
export const BRAND_INITIALS   = "CAS";             // e.g. "AP" — used in decorative elements

// ─── Contact ──────────────────────────────────────────────────────────────────
export const PHONE_LABEL  = "(408) 375-7018";   // e.g. "(408) 898-6999"
export const PHONE_TEL    = "tel:14083757018";  // e.g. "tel:14088986999"
export const BRAND_EMAIL  = "";                    // e.g. "info@airpro.com"
export const BRAND_ADDRESS = "266 Hillsdale Ave San Jose CA 95136";                 // e.g. "1593 Trieste Way, San Jose, CA 95122"
...
export const PRIMARY_COLOR   = "#E52929";   // brand accent — buttons, links, gold
...
export const SEO_TITLE       = "Controlled Air Systems Inc. — San Jose HVAC";
export const SEO_DESCRIPTION = "Controlled Air Systems Inc. — San Jose's trusted HVAC professionals. Professional HVAC Service & Repair in San Jose.";
...
export const HERO_CTA_SECONDARY = "Call 408) 375-7018";   // patched to PHONE_LABEL
export const HERO_SIDE_RAIL_TEXT = "Serving Santa Clara County";
export const HERO_IMG_ALT       = "Controlled Air Systems Inc. technician servicing a residential HVAC system in San Jose";
...
export const TRUST_PILLARS = [
  ...
  {
    num: "04",
    eyebrow: "The Controlled Air Promise",
...
export const TESTIMONIALS = [
  {
    quote: "Great service, very professional and quick.",
    author: "Jane D.",
    role: "Google Review · 5★",
  },
  {
    quote: "They fixed my HVAC problem in no time!",
    author: "Sam R.",
    role: "Google Review · 5★",
  },
  {
    quote: "Highly recommend for any HVAC needs.",
    author: "Alex T.",
    role: "Google Review · 5★",
  },
  {
...
export const FAQ_ITEMS = [
  {
    ...
    a: `Yes — Controlled Air Systems Inc. has been proudly serving the area for years. Most appointments are booked the same week you call, and our service call department is open Monday through Friday, 8:00 AM – 5:00 PM.`,
  },
  {
    q: "Are you licensed, bonded, and insured?",
    a: `Absolutely. Controlled Air Systems Inc. is fully licensed, bonded, and insured. Every technician on our team is trained, professional, and treats your home with respect.`,
  },
  {
  ...
  },
  {
    ...
    a: "We provide Residential and commercial sales and installation, Equipment retrofit and replacement, HRV (Heat Recovery Ventilation), HVAC diagnostic and repair, Air Quality Control, Heat pumps — for both residential and commercial…",
  },
  {
